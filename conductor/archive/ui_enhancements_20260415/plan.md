...
- [x] Task: Write/update unit tests in `WeeklyView.spec.ts` to verify the remaining time calculation and correct rendering. 62fe7fa
- [x] Task: Conductor - User Manual Verification 'Phase 3: Weekly View Remaining Time' (Protocol in workflow.md) 62fe7fa
