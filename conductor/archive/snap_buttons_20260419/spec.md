...
- **Start Time Snap:** A button adjacent to the 'Start Time' input. Clicking it sets the start time to the end time of the chronologically preceding task on the *same day*.
- **End Time Snap:** A button adjacent to the 'End Time' input. Clicking it sets the end time to the start time of the chronologically succeeding task on the *same day*.
