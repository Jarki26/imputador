...
- **Insertion Logic:**
  ...
  3. If there is a conflict with *any other* type of task, insert the new "Descanso" task and allow the user to resolve the resulting overlap manually in the UI.
